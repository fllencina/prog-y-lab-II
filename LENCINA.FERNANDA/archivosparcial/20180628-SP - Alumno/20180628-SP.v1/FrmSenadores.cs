        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    // Guardar resultados
                    DAO<Votacion> test = new DAO<Votacion>();
                    test.Guardar("votacion-sp-2018", votacion);
                    SerializarXML<Votacion> xml = new SerializarXML<Votacion>();
                    xml.Guardar(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), votacion);
                }
            }
        }
